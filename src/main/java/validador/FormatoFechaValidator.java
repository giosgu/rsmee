 ...
 */
@Named
@FacesValidator("custom.formatoFechaValidator")
public class FormatoFechaValidator implements Validator, ClientValidator {
	...
	public void validate(FacesContext context, UIComponent component,
		...
		if (!fecha.equals("admin")){
			if (!StringUtils.fecha(fecha)){
				message.setDetail("No es un Formato Fecha válido");	
	...
	public String getValidatorId() {
		return "custom.formatoFechaValidator";
	}
